...
**対象**: 時間帯分析・商品分析・部門分析・取引管理・明細データタブ
**ステータス**: 未着手
**完了日**: -
...
| --- | ----------------------------------- | :------: | :----: | :--------: | -------------------------- |
| 1   | API拡張（Z002/Z004/Z005/Z009）     |   1,2    |   高   |    [ ]     |                            |
| 2   | 時間帯分析タブ                      |   1,2    |   高   |    [ ]     |                            |
| 3   | 商品分析タブ                        |   1,2    |   高   |    [ ]     | タスク2と並列実行可能      |
| 4   | 部門分析タブ                        |   1,2    |   高   |    [ ]     | タスク2-3と並列実行可能    |
| 5   | 取引管理タブ                        |   1,2    |   中   |    [ ]     | タスク2-4と並列実行可能    |
| 6   | 明細データタブ                      |    1     |   中   |    [ ]     | タスク2-5と並列実行可能    |
| 7   | RegisterDataViewer変更（全タブ統合）|   1,2    |   高   |    [ ]     | タスク2-6完了後            |
| 8   | 動作確認・ビルドテスト              |    -     |   -    |    [ ]     |                            |
