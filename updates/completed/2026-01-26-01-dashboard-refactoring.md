...
| #   | タスク                                           | 優先度 | ステータス | 備考 |
| --- | ------------------------------------------------ | :----: | :--------: | ---- |
| 1   | ProductCardContent コンポーネントの抽出          |   高   |    [o]     |      |
| 2   | useProductSearch フックの抽出                    |   高   |    [o]     |      |
| 3   | DashboardForm と ProductEditForm の統合          |   中   |    [o]     |      |
| 4   | ファイル構造のサブディレクトリ分割               |   中   |    [o]     |      |
| 5   | 型定義の整理と共通化                             |   低   |    [o]     |      |
| 6   | 動作確認・ビルドテスト                           |   -    |    [o]     |      |
...
- [o] ビルドエラーがないこと
- [o] 商品一覧の表示が変わらないこと（本番環境で確認）
- [o] ドラッグ&ドロップが正常に動作すること（本番環境で確認）
...
- [o] ビルドエラーがないこと
- [o] 検索・フィルタリング機能が正常に動作すること（本番環境で確認）
...
- [o] ビルドエラーがないこと
- [o] 商品の新規作成が正常に動作すること（本番環境で確認）
- [o] 商品の編集が正常に動作すること（本番環境で確認）
