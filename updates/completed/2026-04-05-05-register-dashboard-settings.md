...
| --- | ---------------------------------------------- | :------: | :----: | :--------: | --------------------- |
| 1   | 期間プリセットAPI + フック + UI                |   1      |   高   |    [o]     |                       |
| 2   | レジ名称管理API + フック + UI                  |   2      |   高   |    [o]     | タスク1と並列実行可能 |
| 3   | 売上目標API + フック + UI + プログレスバー     |   3      |   高   |    [o]     |                       |
| 4   | ダッシュボード設定API + フック + UI            |   4      |   中   |    [o]     |                       |
| 5   | RegisterDataViewer + SalesOverviewTab変更      |  1,3,4   |   高   |    [o]     |                       |
| 6   | 動作確認・ビルドテスト                         |    -     |   -    |    [o]     |                       |
