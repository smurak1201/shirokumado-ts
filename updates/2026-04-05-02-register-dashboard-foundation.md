...
| 3   | 第1層タブの作成                 |    1     |   高   |    [o]     |                        |
| 4   | データ取得API                   |   2,3    |   高   |    [o]     |                        |
| 5   | レジ番号一覧API                 |    3     |   高   |    [o]     | タスク4と並列実行可能  |
| 6   | データ取得フック                |   2,3    |   高   |    [o]     |                        |
| 7   | 期間セレクター                  |    2     |   高   |    [o]     | タスク8と並列実行可能  |
| 8   | レジフィルター                  |    2     |   高   |    [o]     | タスク7と並列実行可能  |
| 9   | KPIカード                       |    2     |   中   |    [o]     |                        |
| 10  | 汎用テーブル                    |    -     |   中   |    [o]     | タスク9と並列実行可能  |
| 11  | 曜日別グラフ・売上内訳ドーナツ  |    2     |   中   |    [o]     |                        |
| 12  | 売上概要タブ統合                |  1,2,3   |   高   |    [o]     |                        |
| 13  | 動作確認・ビルドテスト          |    -     |   -    |    [o]     |                        |
