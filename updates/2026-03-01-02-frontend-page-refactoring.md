...
| --- | ------------------------------------------------ | :------: | :----: | :--------: | ---------------------------------------- |
| 1   | 絵文字使用禁止ルール違反を修正                   |    2     |   高   |    [o]     |                                          |
| 2   | ページレイアウトを公開サイト用layoutに集約        |   4,5    |   中   |    [o]     | faq/page.tsxのスペーサー不統一も同時解消 |
| 3   | 商品詳細の表示コード重複を解消                   |    1     |   高   |    [o]     |                                          |
| 4   | アニメーション用動的クラスのユーティリティ関数    |    6     |   低   |    [o]     |                                          |
| 5   | 動作確認・ビルドテスト                           |    -     |   -    |    [o]     |                                          |
...
### タスク2: ページレイアウトを公開サイト用layoutに集約 [完了]
...
### タスク4: アニメーション用動的クラスのユーティリティ関数を作成 [完了]
