...
仕様書を作成したら、以下のようにClaudeに作業を依頼できます：

```
updates/README.md と updates/YYYY-MM-DD-NN-タスク名.md を読んで、タスク1から順番に実装してください
```

### Claudeが参照するファイル

- **CLAUDE.md**: プロジェクト全体のコーディング規約。Claudeは自動的にこのファイルを参照します
- **updates/README.md**: 仕様書の書き方ガイド（本ファイル）。進捗更新のルールなどを確認します
