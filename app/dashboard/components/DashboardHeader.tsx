 ...
 * ダッシュボードヘッダー
 *
 * ページタイトル、ユーザー情報、ログアウトボタン、タブナビゲーションを提供。
 * usePathnameでアクティブタブを判定するため、Client Componentとして実装。
 */
'use client';
          ...
          {tabs.map((tab) => {
            ...
            return (
              <Link
                key={tab.href}
                href={tab.href}
                className={`border-b-2 px-3 py-2.5 text-sm font-normal transition-all cursor-pointer active:scale-95 sm:px-4 sm:py-3 ${
                  isActive
