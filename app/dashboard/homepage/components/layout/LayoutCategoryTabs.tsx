/**
 * レイアウト配置変更タブ用のカテゴリータブ
 *
 * カテゴリー別のタブUIを提供。横スクロール対応とアクティブタブの自動スクロールを実装。
 * スクロール位置の監視とDOM操作のため、Client Componentとして実装。
 */
...
function ProductCategoryTabButton({
  ...
  return (
    <button
      ...
      className={`relative whitespace-nowrap border-b-2 pb-3 sm:pb-4 px-2 sm:px-1 text-xs sm:text-sm font-normal transition-colors shrink-0 cursor-pointer ${
        isActive
