...
export default function Footer() {
  return (
    <footer className="border-t border-border bg-linear-to-b from-background to-muted/20 py-12 md:py-16 lg:py-20">
      <div className="mx-auto max-w-6xl px-4 md:px-8">
        ...
        <div className="grid grid-cols-4 gap-1 md:gap-6">
          ...
          <div className="space-y-1 md:space-y-3">
            ...
            <div className="space-y-0.5 text-[8px] leading-relaxed text-muted-foreground md:text-sm">
              <a
                href="mailto:shirokumado.co.jp@gmail.com"
                className={cn(
