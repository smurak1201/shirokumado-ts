...
- [設定ファイル](#設定ファイル)
  ...
  - [パスエイリアス](#パスエイリアス)
- [型定義](#型定義)
  - [フロントエンドの型定義](#フロントエンドの型定義-apptypests)
  - [ダッシュボードの型定義](#ダッシュボードの型定義-appdashboardtypests)
- [型安全性の実装](#型安全性の実装)
  - [コンポーネントでの型安全性](#コンポーネントでの型安全性)
  - [関数での型安全性](#関数での型安全性)
- [Prisma との統合](#prisma-との統合)
  - [型生成](#型生成)
  - [Prisma 型の使用](#prisma-型の使用)
- [API Routes での型安全性](#api-routes-での型安全性)
  - [リクエストの型安全性](#リクエストの型安全性)
  - [レスポンスの型安全性](#レスポンスの型安全性)
- [エラーハンドリングでの型安全性](#エラーハンドリングでの型安全性)
  - [カスタムエラークラス](#カスタムエラークラス)
  - [エラーハンドリングの実装](#エラーハンドリングの実装)
- [型推論](#型推論)
  - [変数の型推論](#変数の型推論)
